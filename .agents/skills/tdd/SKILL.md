...
**Reuse agreed seams and existing public interfaces.** Infer the test boundary from the task, code, and existing tests. Ask the user only when ambiguity in the intended behavior or interface would materially change the implementation.
