...
stage agents go test -mod=readonly -p 1 -race -count=1 -timeout=3m ./tasks ./brain ./adapters/transport/ws ./profiles/asynccheck -run 'Test(Delegation|WSDelegation)' -json > build/agents/agents.jsonl 2> build/agents/agents.stderr
